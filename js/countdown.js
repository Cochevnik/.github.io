...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2020/06/01 18:33:33');

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end"><video controls="controls" autoplay=1><source src=""></video></span></span>');
          timer.countDown();
}
